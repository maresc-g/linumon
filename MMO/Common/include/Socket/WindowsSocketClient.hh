...
// Last update Wed Dec  4 13:41:20 2013 laurent ansel
//
...
public:
  ...
  WindowsSocketClient(WindowsSocketClient *client);
  virtual ~WindowsSocketClient();
  WindowsSocketClient	&operator=(WindowsSocketClient *client);
