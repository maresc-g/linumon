...
// Last update Fri Mar 21 11:19:46 2014 cyril jourdain
//
...
ComputerScreen::ComputerScreen(SFMLView *s, std::string const &) :
  ...
  _yes(new sf::Text()), _no(new sf::Text()), _pos(0), _selection(_yes)
{
  ...
  // _textDraw->setFont(*s->getFont());
  // _textDraw->setString("");
  // _textDraw->setCharacterSize(22);
  // _textDraw->setColor(sf::Color(15,230,30));
  // _textDraw->setStyle(sf::Text::Bold);
