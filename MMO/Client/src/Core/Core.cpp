...
// Last update Fri Mar 14 16:55:18 2014 guillaume marescaux
//
...
{
  (*_proto).operator()<unsigned int const, eInteraction, unsigned int>("INTERACTION", _id, interact, targetId);  
}
