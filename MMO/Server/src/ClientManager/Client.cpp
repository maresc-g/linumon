...
// Last update Mon Feb  3 15:59:18 2014 laurent ansel
//
...
void				Client::sendListPlayers()
{
  if (_user)
    {
      Server::getInstance()->callProtocol<unsigned int const, Players *>("PLAYERLIST", false, _id, const_cast<Players *>(&_user->getPlayers()));
      this->_trame++;
    }
}
